    ...
    const fetchPrivacyData = async () => {
      ...
      try {
        ...
        if (settingsResponse.ok) {
          ...
          setDataSharing(settingsData.dataSharing || false);
          setAnalytics(settingsData.analytics || true);
          setNotifications(settingsData.notifications || true);
          setAccessLevel(settingsData.accessLevel || "Restricted");
        }
